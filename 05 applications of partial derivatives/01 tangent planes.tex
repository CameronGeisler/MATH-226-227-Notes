...
\section*{Tangent Planes to Implicit Surfaces}

For an implicit surface $F(x,y,z) = 0$, the normal vector at $(a,b,c)$ is given by $\nabla F(a,b,c)$, so the equation of the tangent plane is,
\begin{align*}
    \nabla F(a,b,c) \cdot \veciii{x - a}{y - b}{z - c} & = 0 \\
    F_x(a,b,c)(x - a) + F_y(a,b,c)(y - b) + F_z(a,b,c)(z - c) = 0
\end{align*}

\begin{definition}
The \textbf{tangent plane} to the surface $F(x,y,z) = 0$ at a point $(a,b,c)$ has equation,
\begin{align*}
